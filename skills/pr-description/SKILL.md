...
Do not add any AI/assistant attribution or co-author trailer (e.g.
`Co-Authored-By: Claude ...`, "Generated with Claude Code") to the PR
description or its footer. If a sign-off or authorship line is needed,
use only:
